...
const DEFAULT_NAME = localStorage.getItem('healops_user_name') || 'Ray Woo';
const DEFAULT_EMAIL = localStorage.getItem('healops_user_email') || 'wooray2882@gmail.com';
...
export const UserProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const updateProfile = (name: string, email: string) => {
    ...
    localStorage.setItem('healops_user_name', cleanName);
    localStorage.setItem('healops_user_email', cleanEmail);
  };
